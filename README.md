...
SimhaStack is a customized fork of gstack (originally by Garry Tan, MIT License) — adapted by Simhadri Bhukya.

It brings a collection of Claude Code skills and engineering workflows into one installable toolkit.
